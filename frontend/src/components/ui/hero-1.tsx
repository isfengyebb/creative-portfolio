...
export function HeroSection() {
    return (
        <section className="relative mx-auto w-full max-w-5xl">
            ...
            >
                <div className="absolute inset-0 -top-14 isolate z-[-10] bg-[radial-gradient(35%_80%_at_49%_0%,hsl(var(--foreground)/0.08),transparent)]" />
            </div>
            ...
            >
                <div className="absolute inset-y-0 left-0 z-10 h-full w-px bg-gradient-to-b from-transparent via-foreground/15 to-foreground/15" />
                <div className="absolute inset-y-0 right-0 z-10 h-full w-px bg-gradient-to-b from-transparent via-foreground/15 to-foreground/15" />
            </div>
            ...
            <div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-30">
                ...
                <h1 className="animate-in fade-in-0 slide-in-from-bottom-4 text-balance text-center text-4xl tracking-tight delay-100 duration-500 ease-in-out fill-mode-forwards md:text-5xl lg:text-6xl">
                    Building Teams Help <br /> You Scale and Lead
                </h1>

                <p className="mx-auto max-w-md animate-in fade-in-0 slide-in-from-bottom-4 text-center text-base text-foreground/80 tracking-wider delay-200 duration-500 ease-in-out fill-mode-forwards sm:text-lg md:text-xl">
                    Connecting you with world-class talent <br /> to scale, innovate and
                    lead
                </p>

                <div className="flex animate-in fade-in-0 slide-in-from-bottom-4 flex-row flex-wrap items-center justify-center gap-3 pt-2 delay-300 duration-500 ease-in-out fill-mode-forwards">
